...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton btn1 = (ImageButton) findViewById(R.id.bell_btn);
        ...
        ImageButton btn2 = (ImageButton) findViewById(R.id.user_btn);
        ...
        user_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getApplicationContext(), User_Btn.class);
                startActivity(intent);
            }
        });
        ...
        Button button1 = (Button) findViewById(R.id.com_btn);
        Button refrigerator_plz = (Button) findViewById(R.id.com_btn);

        refrigerator_plz.setOnClickListener(new View.OnClickListener() {
        ...
        Button button2 = (Button) findViewById(R.id.recipe_btn);
